...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    ...
    <a href="<?= APP_URL ?>/reports/aging/export/pdf?days=<?= $days ?>" class="inline-flex items-center gap-1.5 rounded-xl bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-700 transition-colors">
...
<!-- Period selector -->
<form method="GET" action="<?= APP_URL ?>/reports/aging" class="mb-6">
