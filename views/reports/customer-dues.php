...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    ...
    <a href="/kinarahub/reports/customer-dues/export/csv" class="inline-flex items-center gap-1.5 rounded-xl bg-green-600 px-4 py-2 text-sm font-semibold text-white hover:bg-green-700 transition-colors">
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-700/50">
                ...
                <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-colors">
                    ...
                    <td class="whitespace-nowrap px-6 py-3 text-right">
                        <a href="/kinarahub/customers/<?= (int)$cust['id'] ?>" class="inline-flex items-center rounded-lg p-2 text-gray-400 hover:text-brand-600 hover:bg-brand-50 dark:hover:text-brand-400 dark:hover:bg-brand-900/20 transition-colors" title="View customer">
