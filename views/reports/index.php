...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <!-- Top Sellers -->
    <a href="<?= APP_URL ?>/reports/top-sellers" class="group rounded-xl bg-white dark:bg-gray-800 p-5 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 hover:ring-brand-300 dark:hover:ring-brand-600 transition-all">
    ...
    <!-- Inventory Aging -->
    <a href="<?= APP_URL ?>/reports/aging" class="group rounded-xl bg-white dark:bg-gray-800 p-5 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 hover:ring-amber-300 dark:hover:ring-amber-600 transition-all">
    ...
    <!-- Profit & Loss -->
    <a href="<?= APP_URL ?>/reports/pnl" class="group rounded-xl bg-white dark:bg-gray-800 p-5 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 hover:ring-emerald-300 dark:hover:ring-emerald-600 transition-all">
    ...
    <!-- Customer Dues -->
    <a href="<?= APP_URL ?>/reports/customer-dues" class="group rounded-xl bg-white dark:bg-gray-800 p-5 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 hover:ring-red-300 dark:hover:ring-red-600 transition-all">
    ...
    <!-- GST Summary -->
    <a href="<?= APP_URL ?>/reports/gst" class="group rounded-xl bg-white dark:bg-gray-800 p-5 shadow-sm ring-1 ring-gray-200 dark:ring-gray-700 hover:ring-blue-300 dark:hover:ring-blue-600 transition-all">
